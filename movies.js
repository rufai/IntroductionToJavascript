...
let movieListElement = document.getElementById("movie_list")
for ( let i = 0; i < comingSoonMovies.length; i++ ){
    let movieEntry = document.createElement("li")
    movieEntry.innerHTML = comingSoonMovies[i].title
    movieListElement.append(movieEntry)
}

console.log (`Number of coming soon movies is: ${comingSoonMovies.length} `)

console.log( comingSoonMovies[0] )
console.log( comingSoonMovies[65] )

console.log( comingSoonMovies[0].actors[2] )

let counter = 0

let buttonPrevious =  document.getElementById("previous_movie")
buttonPrevious.addEventListener("click", function( e ) {
    ...
    let moviePosterElement = document.getElementById("movie_poster")
    let movieTitleElement = document.getElementById("movie_title")
    let moviePositionElement = document.getElementById("movie_position")
    let movieSummaryElement = document.getElementById("movie_summary")
    movieTitleElement.textContent = comingSoonMovies[counter].title
    moviePositionElement.textContent = counter
    movieSummaryElement.textContent = comingSoonMovies[counter].storyline
    moviePosterElement.setAttribute("src", comingSoonMovies[counter].posterurl)
    
    // console.log( counter )
})

let buttonNext =  document.getElementById("next_movie")
...
function searchByGenre( genre ){
    allGenre = []
    for( let index = 0; index < comingSoonMovies.length; index++ ){
        if( comingSoonMovies[index].genres.includes(genre) ){
            allGenre.push( comingSoonMovies[index].title )
        }
    }
    return allGenre
}
...
function searchByYear( year ){
    allYear = []
    for( let counter = 0; counter < comingSoonMovies.length; counter++ ){
        if ( comingSoonMovies[counter].year === year ){
            allYear.push( comingSoonMovies[counter].title )
        }
    }
    return allYear
}
...
let searchElement = document.getElementById("movie_search_genre")
searchElement.addEventListener("keyup", function( e ) {
    console.log ( {e} )
    const searchKeyword = e.target.value
    console.log( searchKeyword )
    ourSearchedArray = searchByGenre( searchKeyword ) 
    console.log( {ourSearchedArray})
})